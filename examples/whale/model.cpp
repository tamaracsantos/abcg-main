...
void Model::update(float delta, const GameData &gameData) {

    auto const RADIUS = 0.5f;
    auto const INTERVAL = 1.5 * delta;
    ...
    m_beta += 0.6 * delta;
    m_alpha += INTERVAL;
    m_position = {RADIUS * sin(m_theta), RADIUS * sin(m_phi), 0};
    m_rotation = {0.0, -1.0, 0.0};
}
